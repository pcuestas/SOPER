...
b) Si no cierra el extremo de escritura el mensaje impreso en pantalla es el mismo pero el programa no finaliza ya que el padre sigue esperando a una escritura en la tubería, ya el descriptor de fichero \texttt{f[1]} sigue abierto: por él mismo.

...
errno=x; /*Aqui aseguramos que la funcion perror() va a imprimir el codigo de error de fopen ya que hemos restaurado el valor de errno asociado a fopen()*/
perror();
\end{lstlisting}
...
int main(int argc, char **argv){
    ...
    sleep(max(strlen(hola), strlen(mundo))); /*evitamos que el hilo principal compruebe constantemente*/

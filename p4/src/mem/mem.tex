...
\footnotetext{El término \textit{turnstile} provienen de \href{https://greenteapress.com/semaphores/LittleBookOfSemaphores.pdf}{The Little Book Of Semaphores}}
...
\addcontentsline{toc}{subsection}{Mantenimiento de la red en caso de la salida repentina de un ganador}

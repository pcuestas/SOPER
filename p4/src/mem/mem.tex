...
\subsubsection*{Problemas de saturación de la cola de mensajes y muerte del monitor}
    ...
    Finalmente, decidimos usar \textit{mq\_timedsend()} para evitar bloqueos indefinidos en el envío de mensajes.

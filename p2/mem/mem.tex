...
b) \texttt{SIGKILL} corresponde al número $9$, y \texttt{SIGSTOP}, al número $19$.
...
b) En este caso, la única señal que se bloquea durante la ejecución de \texttt{manejador} es la señal que ha provocado su ejecución: \texttt{SIGINT}. Esto se debe a que \texttt{act.sa\_mask} con contiene ninguna señal.
